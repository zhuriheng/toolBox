...
scriptFile="mp_refindeDet-res18-inference-demo.py"
inputFile=$1
...
modelName="bk_cls_det-res18-320x320-t2_iter_80000.caffemodel"
deployName="deploy.prototxt"
labelName="labelmap_bk_cls_det_v0.1.prototxt"
for(( i=0;i<$gpuNum;i++))
do
