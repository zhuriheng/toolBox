...
def parse_arg():
    ...
    parser.add_argument('--infer', help='inference result json file under cls48', type=str, default=None)
    parser.add_argument('--gt', help='ground truth under cls48', type=str, default=None)
